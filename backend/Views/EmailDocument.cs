...
public static class EmailDocument
{
    public static HtmlElement Build(string title, string previewText, IEnumerable<HtmlElement> children, HtmlElement footer, Color? backgroundColor = null)
    {
        ...
        // head
        head.AddChild(HtmlTagType.Meta, ("name", "viewport"), ("content", "width=device-width, initial-scale=1.0"));
...
"""
        ...
        // body
        body.AddChild(HtmlTagType.Span, ("class", "preheader")).AddChildString(previewText);
        HtmlElement tr = body
            .AddChild(HtmlTagType.Table, ("class", "body"), ("role", "presentation"), ("border", "0"), ("cellpadding", "0"), ("cellspacing", "0"))
            .AddChild(HtmlTagType.Tr);

        // tr
        tr.AddChild(HtmlTagType.Td).AddChildRaw("&nbsp;");
        HtmlElement div = tr
            .AddChild(HtmlTagType.Td, ("class", "container"))
            .AddChild(HtmlTagType.Div, ("class", "content"));

        // div
        HtmlElement childrenContainer = div.AddChild(HtmlTagType.Table, ("class", "main"), ("role", "presentation"));
        div.AddChild(footer);
